  ...
  return (
    <>
      ...
      <label>
        ...
        >
          <option value="">Equipo central / sin espacio específico</option>
      ...
      <label>
        ...
        <input
          ...
          placeholder="Planta, jornalizado, beca, contrato…"
        />
      </label>
    ...
    <details className={`staff-card staff-status-${persona.estado}`}>
      <summary>
        ...
        <span className="staff-title">
          ...
          <small>{persona.rol || "Rol a completar"} · {espacio?.nombre || "Equipo central"}</small>
        </span>
